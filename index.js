...
+ 'FN:Sultan.mods\n' // Nama
+ 'ORG:Sultan.mods-Bot;\n' // Nama bot
+ 'TEL;type=CELL;type=VOICE;waid=50765475037:+507 6547 5037\n' // Nomor bot
+ 'END:VCARD' 
...
//---Metadata stiker
			function addMetadata(packname, author) {	
				...
				const json = {	
					"sticker-pack-name":𓆩𝓫𝔂𝓿𝓪𝓵𝓮𝓷𝓽𝓲𝓷𝔁𓆪,
					"sticker-pack-publisher":𓆩𝓫𝔂𝓿𝓪𝓵𝓮𝓷𝓽𝓲𝓷𝔁𓆪,
				}
...
‣ Grupo oficialhttps://chat.whatsapp.com/FR10cZ3DaGU3a32hG4DXgo
• _${Wa1}_50765475037
‣ Suscribete://https://youtube.com/channel/UCcW2cwuwpl4ToRsuAh7JAGQ
_${Ig}_@byvalentinx. 
────────────────
┏━━━━━━━━━━━━━━━━━━━━
┃─────〘 🌹𝔟𝔶𝔖𝔲𝔩𝔱𝔞𝔫.𝔅𝔬𝔱⚜️ 〙────
...
Lxa.deleteMessage(from, {
  ...
  reply('Solo puedo borrar mensajes míos puta')
}
break
